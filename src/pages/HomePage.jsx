...
<div className="relative w-full h-[80vh] overflow-hidden">
  <AnimatePresence>
    <motion.img 
      className={`absolute top-0 left-0 w-full h-full object-cover transition duration-700 ${ theme === "dark" ? "brightness-75 contrast-110" : "brightness-105 contrast-95"}`}
      key={index + theme} // re-renders with theme
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
    ...
    >
      HagaGandi — where precision engineering meets trust.  
    ...
    > 
      ...
      <section className="py-16 bg-dark-700 w-full text-center">
        ...
        <div className="max-w-4xl mx-auto text-gold-200 px-6">
          <p className="text-lg leading-relaxed mb-4">
            At HagaGandi, we believe your vehicle deserves care as refined as
            its design. Our team of certified experts handles diagnostics,
            repairs, and preventive maintenance with precision.
          </p>
          <p className="text-lg leading-relaxed">
            From classic rebuilds to high-performance tune-ups — we bring
            reliability, technology, and craftsmanship under one roof.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-dark-800 w-full">
        ...
        >
          <h3 className="text-2xl font-bold mb-4">Rate Our Services</h3>
          <p className="mb-6 text-gold-300">
            Have you had your car serviced at HagaGandi?  
